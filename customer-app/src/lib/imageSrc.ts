...
export function imageSrc(url?: string | null): string | undefined {
  ...
  // `file:///C:/...` left by a picker that never uploaded — would otherwise be concatenated onto
  // the host and render as a permanently broken image. Undefined lets the caller fall back.
