...
// lazy-loads expo-location (so the app still builds/runs if the dep isn't installed
// yet — run `npx expo install expo-location`). Returns null if unavailable/denied.
