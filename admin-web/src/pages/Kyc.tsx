...
export default function Kyc() {
  ...
  return (
    <div>
      ...
      <p className="muted" style={{ marginTop: 0, marginBottom: 20 }}>Review driver verification submissions</p>
      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {items.map((k) => (
            <div key={k.id} className="card" style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <strong style={{ fontSize: 15 }}>Driver {k.userId.slice(0, 8)}…</strong>
