...
import { LatLng, MapMarker, MapProps } from './mapTypes';

export type { LatLng, MapMarker } from './mapTypes';

// Web map for the driver app: Leaflet + OpenStreetMap/Carto tiles in an iframe.
//
// react-native-maps has no web build, so this file used to be a "Map is available on the mobile
// app" placeholder — the driver saw nothing in a browser while the customer saw a live map. This
// is the same implementation the customer app uses, keeping the two sides visually consistent
// and honouring the same MapProps contract as GoogleMap.native.tsx.
//   - "picker": a pin fixed at screen-centre; panning reports the centre coord.
...
export function GoogleMap({ style, center, zoom = 14, mode = 'view', markers = [], driver = null, vehicleKind = 'car', userLocation = null, flyTo = null, route = [], onCenterChange, onReady }: MapProps) {
