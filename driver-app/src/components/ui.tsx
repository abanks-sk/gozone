...
export function SearchBar({
  placeholder, onPress, trailingLabel, elevated = false,
}: { placeholder: string; onPress?: () => void; trailingLabel?: string; elevated?: boolean }) {
  const { colors: c } = useTheme();
  return (
    <TouchableOpacity
      onPress={onPress}
    ...
    >
      ...
      {trailingLabel ? (
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: c.surfaceAlt, borderRadius: 999, paddingHorizontal: 11, paddingVertical: 5 }}>
